...
!function(e){"use strict";var t=function(){var e=document.createElement("div");return e.style.cssText="font-size: 1rem;",/rem/.test(e.style.fontSize)},n=function(){for(var e=document.getElementsByTagName("link"),t=[],n=0;n<e.length;n++)"stylesheet"===e[n].rel.toLowerCase()&&null===e[n].getAttribute("data-norem")&&t.push(e[n].href);return t},r=function(){0===g.length&&(g=n());for(var e=0;e<g.length;e++)l(g[e],c,g[e],e)},c=function(e,t){if(v.push(e.responseText),x.push(t),x.length===g.length){for(var n=0;n<x.length;n++)a(v[n],x[n]);(g=p.slice(0)).length>0?(x=[],v=[],p=[],r()):o()}},a=function(e,t){for(var n,r=s(d(e)),c=/[\w\d\s\-\/\\\[\]:,.'"*()<>+~%#^$_=|@]+\{[\w\d\s\-\/\\%#:!;,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!;,.'"*()]*\}/g,a=r.match(c),o=/\d*\.?\d+rem/g,u=r.match(o),i=/(.*\/)/,l=i.exec(t)[0],f=/@import (?:url\()?['"]?([^'\)"]*)['"]?\)?[^;]*/gm;null!==(n=f.exec(e));)p.push(l+n[1]);null!==a&&0!==a.length&&(y=y.concat(a),S=S.concat(u))},o=function(){for(var e=/[\w\d\s\-\/\\%#:,.'"*()]+\d*\.?\d+rem[\w\d\s\-\/\\%#:!,.'"*()]*[;}]/g,t=0;t<y.length;t++){m+=y[t].substr(0,y[t].indexOf("{")+1);for(var n=y[t].match(e),r=0;r<n.length;r++)m+=n[r],r===n.length-1&&"}"!==m[m.length-1]&&(m+="\n}")}u()},u=function(){for(var e=0;e<S.length;e++)w[e]=Math.round(parseInt(S[e].substr(0,S[e].length-3)*M,10))+"px";i()},i=function(){for(var e=0;e<w.length;e++)w[e]&&(m=m.replace(S[e],w[e]));var t=document.createElement("style");t.setAttribute("type","text/css"),t.id="remReplace",document.getElementsByTagName("head")[0].appendChild(t),t.styleSheet?t.styleSheet.cssText=m:t.appendChild(document.createTextNode(m))},l=function(t,n,r){try{var c=h();c.open("GET",t,!0),c.send();var a=function(){for(var e,t=3,n=document.createElement("div"),r=n.getElementsByTagName("i");n.innerHTML="<!--[if gt IE "+ ++t+"]><i></i><![endif]-->",r[0];);return t>4?t:e}();c.onreadystatechange=a>=7?function(){4===c.readyState&&n(c,r)}:new function(){4===c.readyState&&n(c,r)}}catch(o){if(e.XDomainRequest){var u=new XDomainRequest;u.open("get",t),u.onload=function(){n(u,r)},u.onerror=function(){return!1},u.send()}}},s=function(e){for(var t=e.search(/\/\*/),n=e.search(/\*\//);t>-1&&n>t;)e=e.substring(0,t)+e.substring(n+2),t=e.search(/\/\*/),n=e.search(/\*\//);return e},f=function(){return e.matchMedia||e.msMatchMedia?!0:!1},d=function(e){return f()||(e=e.replace(/@media[\s\S]*?\}\s*\}/,"")),e},h=function(){if(e.XMLHttpRequest)return new XMLHttpRequest;try{return new ActiveXObject("MSXML2.XMLHTTP")}catch(t){try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(n){}}};if(!t()){var m="",g=[],p=[],y=[],S=[],v=[],x=[],w=[],T=document.getElementsByTagName("body")[0],M="";T.currentStyle?M=T.currentStyle.fontSize.indexOf("px")>=0?T.currentStyle.fontSize.replace("px",""):T.currentStyle.fontSize.indexOf("em")>=0?T.currentStyle.fontSize.replace("em",""):T.currentStyle.fontSize.indexOf("pt")>=0?T.currentStyle.fontSize.replace("pt",""):T.currentStyle.fontSize.replace("%","")/100*16:e.getComputedStyle&&(M=document.defaultView.getComputedStyle(T,null).getPropertyValue("font-size").replace("px","")),r()}}(window);
!function(n){"use strict";var t="animsition",i={init:function(a){a=n.extend({inClass:"fade-in",outClass:"fade-out",inDuration:1500,outDuration:800,linkElement:".animsition-link",touchSupport:!0,loading:!0,loadingParentElement:"body",loadingClass:"animsition-loading",unSupportCss:["animation-duration","-webkit-animation-duration","-o-animation-duration"]},a);var o=i.supportCheck.call(this,a);if(o===!1)return"console"in window||(window.console={},window.console.log=function(n){return n}),console.log("Animsition does not support this browser."),i.destroy.call(this);var s="click."+t;return a.touchSupport&&(s+=" touchend."+t),a.loading===!0&&i.addLoading.call(this,a),this.each(function(){var o=this,e=n(this),r=n(window),u=e.data(t);u||(a=n.extend({},a),e.data(t,{options:a}),r.on("load."+t,function(){i.pageIn.call(o)}),r.on("unload."+t,function(){}),n(a.linkElement).on(s,function(t){t.preventDefault();var a=n(this);i.pageOut.call(o,a)}))})},supportCheck:function(t){var i=n(this),a=t.unSupportCss,o=a.length,s=!1;0===o&&(s=!0);for(var e=0;o>e;e++)if("string"==typeof i.css(a[e])){s=!0;break}return s},addLoading:function(t){n(t.loadingParentElement).append('<div class="'+t.loadingClass+'"></div>')},removeLoading:function(){var i=n(this),a=i.data(t).options,o=n(a.loadingParentElement).children("."+a.loadingClass);o.remove()},pageInClass:function(){var i,a=n(this),o=a.data(t).options,s=a.data("animsition-in");return i="string"==typeof s?s:o.inClass},pageInDuration:function(){var i,a=n(this),o=a.data(t).options,s=a.data("animsition-in-duration");return i="number"==typeof s?s:o.inDuration},pageIn:function(){var a=this,o=n(this),s=o.data(t).options,e=i.pageInClass.call(a),r=i.pageInDuration.call(a);s.loading===!0&&i.removeLoading.call(a),o.css({"animation-duration":r/1e3+"s"}).addClass(e),setTimeout(function(){o.removeClass(e).css({opacity:1})},r)},pageOutClass:function(i){var a,o=n(this),s=o.data(t).options,e=i.data("animsition-out"),r=o.data("animsition-out");return a="string"==typeof e?e:"string"==typeof r?r:s.outClass},pageOutDuration:function(i){var a,o=n(this),s=o.data(t).options,e=i.data("animsition-out-duration"),r=o.data("animsition-out-duration");return a="number"==typeof e?e:"number"==typeof r?r:s.outDuration},pageOut:function(t){var a=this,o=n(this),s=t.attr("href"),e=i.pageOutClass.call(a,t),r=i.pageOutDuration.call(a,t);o.css({"animation-duration":r/1e3+"s"}).addClass(e),setTimeout(function(){location.href=s},r)},destroy:function(){return this.each(function(){var i=n(this);n(window).unbind("."+t),i.removeClass(t).removeData(t)})}};n.fn.animsition=function(a){return i[a]?i[a].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof a&&a?(n.error("Method "+a+" does not exist on jQuery."+t),void 0):i.init.apply(this,arguments)}}(jQuery);
function sizeProject(){var n=$(".project--single").width();$(".project--single").css("height",n-n/4)}$(function(){$(".animsition").animsition({inClass:"fade-in",outClass:"fade-out",inDuration:500,outDuration:250,linkElement:'a:not([target="_blank"]):not([href^=#])',loading:!0,loadingParentElement:"html",loadingClass:"animsition-loading"}),$("body").on("click",".nav--menu--trigger",function(n){$(this).add(".nav--menu, html, body").toggleClass("open"),n.preventDefault()}),$(document).keyup(function(n){27==n.keyCode&&($(".nav--menu--trigger").removeClass("open"),$(".nav--menu").removeClass("open"))}),sizeProject(),$(window).resize(function(){sizeProject()}),$(window).scroll(function(){$(window).scrollTop()+$(window).height()<$(document).height()&&($(window).scrollTop()>0?($(".site--header, #masthead, .nav--menu, .contents").addClass("scrolled"),$(".site--nav span").fadeOut(300)):($(".site--header, #masthead, .nav--menu, .contents").removeClass("scrolled"),$(".site--nav span").fadeIn(300)))})});