...
$(function(){$("body").fadeIn(400),$("body").on("click","a[href^='/']",function(n){var e=$(this).attr("href");$("body").fadeOut(400,function(){window.location.href=e}),n.preventDefault()}),$("body").on("click",".nav-menu-trigger",function(n){$(this).toggleClass("open"),$(".nav-menu").toggleClass("visible"),n.preventDefault()})});