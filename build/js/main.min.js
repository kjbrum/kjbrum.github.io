...
$(function(){var e={after:"0s",enter:"bottom",move:"100%",over:"0.75s",easing:"ease-in-out",viewportFactor:.5,opacity:100,reset:!0,init:!0};window.sr=new scrollReveal(e),$("body").on("click",".nav-menu-trigger",function(e){$(this).add(".nav-menu, html, body").toggleClass("open"),e.preventDefault()}),$(document).keyup(function(e){27==e.keyCode&&($(".nav-menu-trigger").removeClass("open"),$(".nav-menu").removeClass("open"))})});