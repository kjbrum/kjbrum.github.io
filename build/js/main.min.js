...
$(function(){$("body").on("click",".nav-menu-trigger",function(e){$(this).add(".nav-menu, html, body").toggleClass("open"),e.preventDefault()}),$(document).keyup(function(e){27==e.keyCode&&($(".nav-menu-trigger").removeClass("open"),$(".nav-menu").removeClass("open"))}),$(window).scroll(function(){$(window).scrollTop()+$(window).height()<$(document).height()&&($(window).scrollTop()>0?($(".site-header, #masthead, .nav-menu, .contents").addClass("scrolled"),$(".site-nav span").fadeOut(300)):($(".site-header, #masthead, .nav-menu, .contents").removeClass("scrolled"),$(".site-nav span").fadeIn(300)))})});
